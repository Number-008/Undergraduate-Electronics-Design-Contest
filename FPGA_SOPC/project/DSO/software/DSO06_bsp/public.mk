...
SOPCINFO_FILE := F:/Qsys/DSO_2014_1/NIOS2.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x24f0
SOPC_SYSID_FLAG += --sidp=0x24f0
ELF_PATCH_FLAG  += --sidp 0x24f0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1400146849
SOPC_SYSID_FLAG += --timestamp=1400146849
ELF_PATCH_FLAG  += --timestamp 1400146849
