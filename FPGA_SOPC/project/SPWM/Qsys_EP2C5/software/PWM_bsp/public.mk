...
SOPCINFO_FILE := F:/Qsys/Qsys_EP2C5/Qsys.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x6078
SOPC_SYSID_FLAG += --sidp=0x6078
ELF_PATCH_FLAG  += --sidp 0x6078

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1375016821
SOPC_SYSID_FLAG += --timestamp=1375016821
ELF_PATCH_FLAG  += --timestamp 1375016821
