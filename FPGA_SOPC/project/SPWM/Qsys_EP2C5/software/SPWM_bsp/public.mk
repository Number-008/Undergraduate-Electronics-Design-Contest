...
SOPCINFO_FILE := F:/Qsys/SPWM/Qsys_EP2C5/Qsys.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x6038
SOPC_SYSID_FLAG += --sidp=0x6038
ELF_PATCH_FLAG  += --sidp 0x6038

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1375083247
SOPC_SYSID_FLAG += --timestamp=1375083247
ELF_PATCH_FLAG  += --timestamp 1375083247
